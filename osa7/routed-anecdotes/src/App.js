...
const Home = (props) => {
    ...
    return (
        <div>
            <h1>Software anecdotes</h1>
            <Menu notification={props.notification} />
...
const App = () => {
    ...
    return (
        <div>
            <Router>
                <div>
                    <Route exact path="/" render={() => <Home anecdotes={anecdotes} addNew={addNew} notification={notification} setNotification={v => setNotification(v)} />} />
                    <Route exact path="/create" render={() => <CreateNew setNotification={v => setNotification(v)} />} />
