...
test('update blog', async () => {
    ...
    await api.post('/api/blogs/5a422aa71b54a676234d17f8').send(newBlog).expect(200);

    var likes = await Blog.findById('5a422aa71b54a676234d17f8');
    expect(likes.likes).toBe(8);
});
